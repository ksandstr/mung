...
Mung::SingleResult - container for the results of a single test program
invocation
...
# and Mung::SingleResult, which leads to confusing callsites.
has 'results' => (
	is => 'ro',
